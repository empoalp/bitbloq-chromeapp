...
exports.SerialConnection.prototype.onConnectComplete = function(
  connectionInfo
) {
  if (!connectionInfo) {
...
exports.SerialConnection.prototype.onReceive = function(receiveInfo) {
  if (receiveInfo.connectionId !== this.connectionId) {
    ...
    if (
      this.lineBuffer.indexOf(this.endLineCharacter) !== -1 ||
      this.lineBuffer.length > 40
    ) {
      ...
      if (this.sendData) {
        if (this.onReadLine) {
          this.onReadLine(this.lineBuffer);
        }
      }
      this.lineBuffer = '';
    }
